package eoc.studio.voicecard.facebook.entities;
...
import eoc.studio.voicecard.facebook.Properties;
...
public class Profile
{
	...
	public List<Education> getEducation()
	{
		...
		GraphObjectList<GraphObject> graphObjectList = mGraphUser.getPropertyAsList(
				Properties.EDUCATION, GraphObject.class);
	...
	{
		String relationshipStatus = String.valueOf(mGraphUser
				.getProperty(Properties.RELATIONSHIP_STATUS));
	...
	public List<Work> getWork()
	{
		...
		GraphObjectList<GraphObject> graphObjectList = mGraphUser.getPropertyAsList(
				Properties.WORK, GraphObject.class);
		for (GraphObject graphObject : graphObjectList)
		{
