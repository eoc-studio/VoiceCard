...
import eoc.studio.voicecard.facebook.Privacy;
...
public class Video
{
	...
	/**
	 * @param videoFileName
	 *            A valid video file name.<br/>
	 *            Have to be something with a valid extensions (for example:
	 *            video.mp4)
	 * @param bytes
	 *            The byte array of the video file
	 */
