...
public class SetCalendarMainView extends FragmentActivity implements OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        DataProcess.setSelectedEventDate((String) bundle.getString(DataProcess.EVENT_DATE).toString());
    ...
    private void findView()
    {
        ...
        addButton = (Button) findViewById(R.id.buttonBackView);
        confirmButton = (Button) findViewById(R.id.buttonAddView);
        titleTextView.setText(DataProcess.formatDate(
                DataProcess.getDataMilliSeconds(DataProcess.getSelectedEventDate()), "yyyy-MM-dd(E)"));
    }
    ...
    public void onClick(View view)
    {
        switch (view.getId())
        {
            ...
            {
                ShowDialog.showSetValueDialog(mContext, DataProcess.formatDate(
                        DataProcess.getDataMilliSeconds(DataProcess.getSelectedEventDate()), "yyyyMMdd"));
            }
                break;
        }
    }
