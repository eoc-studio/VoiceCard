...
/**
 * http://www.androiddevelopersolution.com/2012/11/horizontal-listview-in-
 * android-example.html
 */
public class HorizontalListView<T extends Adapter> extends AdapterView<T>
{

	public boolean isAlwaysOverrideTouch = true;
	...
	protected synchronized void onLayout(boolean changed, int left, int top, int right, int bottom)
	{
		...
		{
			post(requestLayoutAction);

		}
	}

	private Runnable requestLayoutAction = new Runnable()
	{
		@Override
		public void run()
		{
